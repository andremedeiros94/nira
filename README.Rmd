...
---
![](https://raw.githubusercontent.com/admedeiros/nira/master/logo/logo.png)
...
if(!require(devtools)) install.packages("devtools")
if(require(niradm)) remove.packages("nira")
.rs.restartR()
if(!require(nira)) devtools::install_github("admedeiros/nira")
...
```{r, fig.keep='all', fig.width=15, fig.height=5,include=FALSE}
...
```{r  fig.keep='all', fig.width=20, fig.height=5,include=FALSE}
pca_df(nir_seed,1,2)
```

### Autoscaling
```{r, message=FALSE, fig.keep='all', fig.width=20, fig.height=5,include=FALSE}
data(nir_seed)
